...
const features = [
  'Multi-academy trust (MAT) IT management',
  'EdTech platform integration and support',
  'Safeguarding and DfE compliance',
  'Student and staff device programmes',
  'Microsoft 365 Education licensing & deployment',
  'Network infrastructure for schools and colleges',
  'Cloud backup and disaster recovery',
  'Managed print and hardware procurement',
];

const benefits = [
  { title: 'MAT Expertise', desc: 'We work with multi-academy trusts of all sizes, delivering consistent IT across multiple sites under one contract.' },
  { title: 'Safeguarding Ready', desc: 'Content filtering, monitoring tools, and security policies aligned to Keeping Children Safe in Education (KCSiE).' },
  { title: 'DfE Aligned', desc: 'Our solutions meet Department for Education technology standards and approved supplier frameworks.' },
  { title: 'Budget Conscious', desc: 'Flexible contracts and volume licensing to stretch your IT budget further without compromising on quality.' },
];
    ...
    <>
      <section style={{ background: 'var(--color-navy)', paddingBlock: '5rem', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0 }} aria-hidden="true">
          ...
          <img src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&w=1200&q=80" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.1 }} />
        </div>
        <div className="container" style={{ position: 'relative' }}>
          ...
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.8)', lineHeight: 1.7, maxWidth: '580px', marginBottom: '2.5rem' }}>
            From primary schools and academy trusts to further and higher education — we deliver technology that supports learning and keeps students and staff safe online.
          </p>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '4rem', alignItems: 'start' }}>
            ...
            <div style={{ borderRadius: '1rem', overflow: 'hidden', aspectRatio: '4/3', background: 'var(--color-gray-100)' }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&w=800&q=80" alt="Education IT" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-sm">
        <div className="container">
          ...
          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
            ...
            <Link href="/services/hardware" className="btn btn-outline btn-sm">Hardware & Configuration <ArrowRight size={14} aria-hidden="true" /></Link>
            <Link href="/services/software" className="btn btn-outline btn-sm">Software Solutions <ArrowRight size={14} aria-hidden="true" /></Link>
          </div>
        </div>
      </section>
