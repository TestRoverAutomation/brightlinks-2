...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about BrightLinks UK — a London-based IT solutions provider serving SMEs, enterprise, public sector, and education across the UK.',
};
      ...
      <section style={{ background: 'var(--color-navy)', paddingBlock: '5rem', color: 'white' }}>
        <div className="container">
          ...
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.8)', lineHeight: 1.7, maxWidth: '600px' }}>
            Based in the heart of London, BrightLinks UK delivers enterprise-grade IT solutions to organisations of all sizes — from ambitious SMEs to complex public sector bodies.
          </p>
        </div>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '4rem', alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontSize: '1rem', color: 'var(--color-gray-600)', lineHeight: 1.8, marginBottom: '1.25rem' }}>
                BrightLinks UK was founded with a simple mission: to make enterprise-level IT accessible to every UK business, regardless of size or sector. We believe technology should be an enabler — not a burden.
              </p>
              <p style={{ fontSize: '1rem', color: 'var(--color-gray-600)', lineHeight: 1.8, marginBottom: '2rem' }}>
                From our London base at 124 City Road, our team of certified engineers and consultants work closely with clients to design, implement, and manage IT solutions that genuinely make a difference.
              </p>
            ...
            <div style={{ borderRadius: '1rem', overflow: 'hidden', aspectRatio: '4/3', background: 'var(--color-gray-100)' }}>
              ...
              <img
                ...
                alt="BrightLinks UK team collaborating"
      ...
      <section className="section">
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '1.5rem' }}>
            {['Microsoft Gold Partner', 'Cyber Essentials Plus', 'ISO 27001 Aligned', 'ITIL V4', 'WEEE Certified', 'G-Cloud Accredited'].map(cert => (
